...
describe('FaceRecognitionDemoApp', function() {
  ...
  describe('FaceRecognition page', function() {
    ...
    *********************************************************************************************************/
    ...
    beforeEach(function() {
      login_page.selectProduct('Identificación Facial');
    ...
    it('should get the entire empty page', function() {
      expect(facerecognition_page.getPanelTitle()).toBe('Identificación Facial');
    ...
    it('should set Pattern attributes values and set an video to Pattern drop area and then show train status glyphicon ok', function() {
      ...
      var elementPanelPattern = facerecognition_page.getPanelPattern();
      elementPanelPattern.getText().then(function(text){expect(text).toContain("Documento a la espera")});
      ...
      browser.sleep(300);
      elementPanelPattern.getText().then(function(text){expect(text).toContain("Procesando documento")});

      browser.sleep(waitTimeOut);
      elementPanelPattern.getText().then(function(text){expect(text).toContain("Documento recibido e identificado")});
      ...
      elementPanelTitlePattern.getText().then(function(text){expect(text).toContain("Patrón de Referencia")});
    ...
    it('should set an video/image to every drop area and show all complete results', function() {
      ...
      expect(selectedIdentityMedia.get(0).getAttribute('innerText')).toContain('Imagen');

      var elementPanelTitleIdentityMedia = facerecognition_page.getPanelTitleIdentityMedia();
      elementPanelTitleIdentityMedia.getText().then(function(text){expect(text).toContain("Identificación Facial")});

      var elementPanelIdentityMedia = facerecognition_page.getPanelIdentityMedia();
      elementPanelIdentityMedia.getText().then(function(text){expect(text).toContain("Documento a la espera")});
      ...
      elementPanelTitleIdentityMedia.getText().then(function(text){expect(text).toContain("Identificación Facial Imagen")});
      elementPanelIdentityMedia.getText().then(function(text){expect(text).toContain("Documento recibido e identificado")});
      ...
      browser.sleep(300);
      elementPanelIdentityMedia.getText().then(function(text){expect(text).toContain("Procesando documento")});
