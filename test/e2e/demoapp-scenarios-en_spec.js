  ...
  describe('Validation page', function() {
    ...
    ******************************************************************************/
    ...
    it('should show modal message when only Dni document is loaded and click on Terminate button', function() {
      ...
      expect(validation_page.getModalMessage()).toBe('There are missing documents');
      browser.sleep(3000);                
    ...
    it('should set an image to every drop area and show all complete results', function() {
      ...
      elementPanelTitleReceipt.getText().then(function(text){expect(text).toContain("Receipt")});      
      ...
      validation_page.setBankReceiptAccount('2100 2794 960100123491');
      absolutePath = path.resolve(__dirname, "./resources/JustificanteBancario.jpg");
      ...
      validation_page.setPaysheetAmount('1.423,86');
      absolutePath = path.resolve(__dirname, "./resources/Nomina.jpg");
    ...
    it('should set a Bank Receipt when automatic is selected and OCR return Bank Receipt in Receipt', function() {
      ...
      validation_page.setAutomaticAccount('2100 2794 960100123491');
      absolutePath = path.resolve(__dirname, "./resources/JustificanteBancario.jpg");
      ipsaImgList.get(1).sendKeys(absolutePath);
      ...
      expect(validation_page.getBankReceiptAccount()).toContain('2100 2794 960100123491');
    ...
    it('should set a Paysheet when automatic is selected and OCR return Paysheet in Income', function() {
      ...
      validation_page.setAutomaticAmount('1.423,86');
      absolutePath = path.resolve(__dirname, "./resources/Nomina.jpg");
      ipsaImgList.get(2).sendKeys(absolutePath);
      ...
      // and the introduced data has been moved from automatic model to real recognized type model
      expect(validation_page.getPaysheetAmount()).toContain('1.423,86');
